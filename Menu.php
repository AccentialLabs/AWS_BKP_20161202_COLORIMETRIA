...
echo '<link rel="stylesheet" href="css/page/base.css">';
...
echo "<nav id='myNavmenu' class='navmenu navmenu-default navmenu-fixed-left offcanvas' role='navigation'>
    ...
    <ul class='nav navmenu-nav'>
        <li class='".$active["home"]."'><a href='https://secure.jezzy.com.br/jezzy-mobile/public_html/home.html'><img src='img/icons/homeFooterIcon.PNG' class='icon-bar'>HOME</a></li>
        <li class='".$active["agenda"]."'><a href='https://secure.jezzy.com.br/jezzy-mobile/public_html/company_selection.html'><img src='img/icons/calendarFooterIcon.PNG' class='icon-bar'>AGENDAR</a></li>
        <li class='".$active["ofertas"]."'><a href='https://secure.jezzy.com.br/jezzy-mobile/public_html/offer_display.html'><img src='img/icons/offerFooterIcon.PNG' class='icon-bar'>OFERTAS</a></li>
        <li class='".$active["servicos"]."'><a href='https://secure.jezzy.com.br/jezzy-mobile/public_html/services_history.html'><img src='img/icons/Servicos.png' class='icon-bar'>SERVIÇOS REALIZADOS</a></li>
        <li class='".$active["compras"]."'><a href='https://secure.jezzy.com.br/jezzy-mobile/public_html/offer_history.html'><img src='img/icons/cardFooterIcon.PNG' class='icon-bar'>COMPRAS REALIZADAS</a></li>
        <li class='".$active["voucher"]."'><a href='https://secure.jezzy.com.br/jezzy-mobile/public_html/vouchers_list.html'><img src='img/icons/Voucher-02.png' class='icon-bar'>MEUS VOUCHERS</a></li>
