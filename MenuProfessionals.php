...
echo "<nav id='myNavmenu' class='navmenu navmenu-default navmenu-fixed-left offcanvas' role='navigation'>
    <a class='navmenu-brand' id='userName' href='#'>".$user."<br><small>".$salao."</small></a>
    <ul class='nav navmenu-nav'>
        <li class='".$active["home"]."'><a href='https://secure.jezzy.com.br/jezzy-mobile-professionals/public_html/home.html'><img src='img/icons/homeFooterIcon.PNG' class='icon-bar'>HOME</a></li>
        <li class='".$active["servicos"]."'><a href='https://secure.jezzy.com.br/jezzy-mobile-professionals/public_html/services_history.html'><img src='img/icons/Servicos.png' class='icon-bar'>SERVIÇOS REALIZADOS</a></li>
